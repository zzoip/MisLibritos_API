<?php
    ...
    class librito extends conexion{
         ...
         public function insertarLibrito($json){
          
            #convertimos el json a un array asociativo
            $datos = json_decode($json, true);
             #si no estan los datos requeridos
            if (!isset($datos['Titulo']) ||  !isset($datos['Autor']) || !isset($datos['Descripcion']) || !isset($datos['Imagen'])|| !isset($datos['Precio'])) {
               ...
               // id_pelicula autonumerico
                $query = "INSERT INTO libritos (id, Titulo,Autor,Descripcion,Imagen,Precio) VALUES (NULL, '$titulo','$autor', '$descripcion', '$imagen','$precio')";
                //$query = "INSERT INTO libritos (Titulo,Autor,Descripcion,Imagen,Precio) VALUES ('$titulo','$autor', '$descripcion', '$imagen','$precio')";   
        ...
        public function listarLibritos($pagina){
            ...
            $query = "SELECT * FROM libritos LIMIT $inicio, $cantidad";
